...
public class RangeKeyValuesQueryVerticleTest {
    ...
    public void noValidKeySerde(TestContext context){
        ...
        rule.vertx().deployVerticle(new RangeKeyValueQueryVerticle("host", streamMock), context.asyncAssertSuccess(deployment->{
            ...
            RangeKeyValueQuery query = new RangeKeyValueQuery("store", "i am not a serde", Serdes.String().getClass().getName(), "key".getBytes(), "key".getBytes());
    ...
    public void noValidValueSerde(TestContext context){
        ...
        rule.vertx().deployVerticle(new RangeKeyValueQueryVerticle("host", streamMock), context.asyncAssertSuccess(deployment->{
            ...
            RangeKeyValueQuery query = new RangeKeyValueQuery("store", Serdes.String().getClass().getName(),"i am not a serde", "key".getBytes(), "key".getBytes());
